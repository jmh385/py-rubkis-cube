...
from ml.data_collection.create_dataset import write_dataset
...
TIME_BETWEEN_MOVES_SECONDS = 0.1
...
#                 moves = deepcopy(solve_cube(cube, False))
#                 current_move = 0
